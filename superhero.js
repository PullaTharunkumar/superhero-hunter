...
// comics Event hander
const comics = async () => {
    await render('comics') // Displaying comics
}

// events Event hander
const events = async () => {
    await render('events') // Displaying comics events
}

//series Event hander
const series = async () => {
    await render('series') // Displaying comics series
}
// stories Event hander
const stories = async () => {
    await render('stories') // Displaying comics stories
}
